<template>
  <div>
    <div class="message warning p-shadow-14" v-on:keyup.enter="login()">
      <div class="inset">
        <div class="login-head">
          <h1>Inisio de sessión</h1>
        </div>
        <div class="form">
          <li>
          ...
          <div class="clear"></div>
          <div class="submit">
            <input type="submit" v-on:click="login()" value="Entrar" />
            <h4><a href="#">Ha olvidado su contraseña?</a></h4>
            <div class="clear"></div>
          </div>
        </div>
      </div>
...
.message {
  box-shadow: 0 0 0 1px rgba(0, 0, 0, 0.2) inset,
    0 1px 0 rgba(255, 255, 255, 0.1) inset, 0 1px 2px rgba(0, 0, 0, 0.4);
  position: relative;
}
.warning {
  text-align: center;
